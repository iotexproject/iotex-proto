...
type ReadStakingDataRequest_Count struct {
	Count *ReadStakingDataRequest_TotalCount `protobuf:"bytes,6,opt,name=count,proto3,oneof"`
}
...
func (*ReadStakingDataRequest_Count) isReadStakingDataRequest_Request() {}
...
func (m *ReadStakingDataRequest) GetCount() *ReadStakingDataRequest_TotalCount {
	if x, ok := m.GetRequest().(*ReadStakingDataRequest_Count); ok {
		return x.Count
	}
	return nil
}
...
func (*ReadStakingDataRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*ReadStakingDataRequest_Count)(nil),
	}
}
...
type ReadStakingDataRequest_TotalCount struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ReadStakingDataRequest_TotalCount) Reset()         { *m = ReadStakingDataRequest_TotalCount{} }
func (m *ReadStakingDataRequest_TotalCount) String() string { return proto.CompactTextString(m) }
func (*ReadStakingDataRequest_TotalCount) ProtoMessage()    {}
func (*ReadStakingDataRequest_TotalCount) Descriptor() ([]byte, []int) {
	return fileDescriptor_a08103f271b0c8be, []int{2, 5}
}

func (m *ReadStakingDataRequest_TotalCount) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ReadStakingDataRequest_TotalCount.Unmarshal(m, b)
}
func (m *ReadStakingDataRequest_TotalCount) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ReadStakingDataRequest_TotalCount.Marshal(b, m, deterministic)
}
func (m *ReadStakingDataRequest_TotalCount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReadStakingDataRequest_TotalCount.Merge(m, src)
}
func (m *ReadStakingDataRequest_TotalCount) XXX_Size() int {
	return xxx_messageInfo_ReadStakingDataRequest_TotalCount.Size(m)
}
func (m *ReadStakingDataRequest_TotalCount) XXX_DiscardUnknown() {
	xxx_messageInfo_ReadStakingDataRequest_TotalCount.DiscardUnknown(m)
}

var xxx_messageInfo_ReadStakingDataRequest_TotalCount proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*ReadStakingDataRequest_TotalCount)(nil), "iotexapi.ReadStakingDataRequest.TotalCount")
}
...
var fileDescriptor_a08103f271b0c8be = []byte{
	...
	,
}
