...
type EstimateGasForActionsRequest struct {
	Execution            *iotextypes.Execution `protobuf:"bytes,1,opt,name=execution,proto3" json:"execution,omitempty"`
	CallerAddress        string                `protobuf:"bytes,2,opt,name=callerAddress,proto3" json:"callerAddress,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
...
func (m *EstimateGasForActionsRequest) Reset()         { *m = EstimateGasForActionsRequest{} }
func (m *EstimateGasForActionsRequest) String() string { return proto.CompactTextString(m) }
func (*EstimateGasForActionsRequest) ProtoMessage()    {}
func (*EstimateGasForActionsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca6d5bbc959d58c0, []int{31}
}

func (m *EstimateGasForActionsRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_EstimateGasForActionsRequest.Unmarshal(m, b)
}
func (m *EstimateGasForActionsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_EstimateGasForActionsRequest.Marshal(b, m, deterministic)
}
func (m *EstimateGasForActionsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EstimateGasForActionsRequest.Merge(m, src)
}
func (m *EstimateGasForActionsRequest) XXX_Size() int {
	return xxx_messageInfo_EstimateGasForActionsRequest.Size(m)
}
func (m *EstimateGasForActionsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_EstimateGasForActionsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_EstimateGasForActionsRequest proto.InternalMessageInfo

func (m *EstimateGasForActionsRequest) GetExecution() *iotextypes.Execution {
	if m != nil {
		return m.Execution
	}
	return nil
...
func (m *EstimateGasForActionsRequest) GetCallerAddress() string {
	if m != nil {
		return m.CallerAddress
	}
	return ""
...
type EstimateGasForTransferRequest struct {
	Transfer             *iotextypes.Transfer `protobuf:"bytes,1,opt,name=transfer,proto3" json:"transfer,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}

func (m *EstimateGasForTransferRequest) Reset()         { *m = EstimateGasForTransferRequest{} }
func (m *EstimateGasForTransferRequest) String() string { return proto.CompactTextString(m) }
func (*EstimateGasForTransferRequest) ProtoMessage()    {}
func (*EstimateGasForTransferRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca6d5bbc959d58c0, []int{32}
}

func (m *EstimateGasForTransferRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_EstimateGasForTransferRequest.Unmarshal(m, b)
}
func (m *EstimateGasForTransferRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_EstimateGasForTransferRequest.Marshal(b, m, deterministic)
}
func (m *EstimateGasForTransferRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EstimateGasForTransferRequest.Merge(m, src)
}
func (m *EstimateGasForTransferRequest) XXX_Size() int {
	return xxx_messageInfo_EstimateGasForTransferRequest.Size(m)
}
func (m *EstimateGasForTransferRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_EstimateGasForTransferRequest.DiscardUnknown(m)
}

var xxx_messageInfo_EstimateGasForTransferRequest proto.InternalMessageInfo

func (m *EstimateGasForTransferRequest) GetTransfer() *iotextypes.Transfer {
	if m != nil {
		return m.Transfer
	}
	return nil
...
type EstimateGasForActionRequestNew struct {
	// Types that are valid to be assigned to Lookup:
	//	*EstimateGasForActionRequestNew_ByAction
	//	*EstimateGasForActionRequestNew_ByTransfer
	Lookup               isEstimateGasForActionRequestNew_Lookup `protobuf_oneof:"lookup"`
	XXX_NoUnkeyedLiteral struct{}                                `json:"-"`
	XXX_unrecognized     []byte                                  `json:"-"`
	XXX_sizecache        int32                                   `json:"-"`
}

func (m *EstimateGasForActionRequestNew) Reset()         { *m = EstimateGasForActionRequestNew{} }
func (m *EstimateGasForActionRequestNew) String() string { return proto.CompactTextString(m) }
func (*EstimateGasForActionRequestNew) ProtoMessage()    {}
func (*EstimateGasForActionRequestNew) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca6d5bbc959d58c0, []int{33}
}

func (m *EstimateGasForActionRequestNew) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_EstimateGasForActionRequestNew.Unmarshal(m, b)
}
func (m *EstimateGasForActionRequestNew) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_EstimateGasForActionRequestNew.Marshal(b, m, deterministic)
}
func (m *EstimateGasForActionRequestNew) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EstimateGasForActionRequestNew.Merge(m, src)
}
func (m *EstimateGasForActionRequestNew) XXX_Size() int {
	return xxx_messageInfo_EstimateGasForActionRequestNew.Size(m)
}
func (m *EstimateGasForActionRequestNew) XXX_DiscardUnknown() {
	xxx_messageInfo_EstimateGasForActionRequestNew.DiscardUnknown(m)
}

var xxx_messageInfo_EstimateGasForActionRequestNew proto.InternalMessageInfo

type isEstimateGasForActionRequestNew_Lookup interface {
	isEstimateGasForActionRequestNew_Lookup()
}

type EstimateGasForActionRequestNew_ByAction struct {
	ByAction *EstimateGasForActionsRequest `protobuf:"bytes,1,opt,name=byAction,proto3,oneof"`
}

type EstimateGasForActionRequestNew_ByTransfer struct {
	ByTransfer *EstimateGasForTransferRequest `protobuf:"bytes,2,opt,name=byTransfer,proto3,oneof"`
}

func (*EstimateGasForActionRequestNew_ByAction) isEstimateGasForActionRequestNew_Lookup() {}

func (*EstimateGasForActionRequestNew_ByTransfer) isEstimateGasForActionRequestNew_Lookup() {}

func (m *EstimateGasForActionRequestNew) GetLookup() isEstimateGasForActionRequestNew_Lookup {
	if m != nil {
		return m.Lookup
	}
	return nil
...
func (m *EstimateGasForActionRequestNew) GetByAction() *EstimateGasForActionsRequest {
	if x, ok := m.GetLookup().(*EstimateGasForActionRequestNew_ByAction); ok {
		return x.ByAction
	}
	return nil
}

func (m *EstimateGasForActionRequestNew) GetByTransfer() *EstimateGasForTransferRequest {
	if x, ok := m.GetLookup().(*EstimateGasForActionRequestNew_ByTransfer); ok {
		return x.ByTransfer
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*EstimateGasForActionRequestNew) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*EstimateGasForActionRequestNew_ByAction)(nil),
		(*EstimateGasForActionRequestNew_ByTransfer)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*EstimateGasForActionsRequest)(nil), "iotexapi.EstimateGasForActionsRequest")
	proto.RegisterType((*EstimateGasForTransferRequest)(nil), "iotexapi.EstimateGasForTransferRequest")
	proto.RegisterType((*EstimateGasForActionRequestNew)(nil), "iotexapi.EstimateGasForActionRequestNew")
...
var fileDescriptor_ca6d5bbc959d58c0 = []byte{
	...
	,
}
...
type APIServiceClient interface {
	...
	EstimateGasForActionNew(ctx context.Context, in *EstimateGasForActionRequestNew, opts ...grpc.CallOption) (*EstimateGasForActionResponse, error)
...
func (c *aPIServiceClient) EstimateGasForActionNew(ctx context.Context, in *EstimateGasForActionRequestNew, opts ...grpc.CallOption) (*EstimateGasForActionResponse, error) {
	out := new(EstimateGasForActionResponse)
	err := c.cc.Invoke(ctx, "/iotexapi.APIService/EstimateGasForActionNew", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServiceServer interface {
	...
	// estimate gas for action and transfer not sealed
	EstimateGasForActionNew(context.Context, *EstimateGasForActionRequestNew) (*EstimateGasForActionResponse, error)
	// read state from blockchain
...
func _APIService_EstimateGasForActionNew_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EstimateGasForActionRequestNew)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServiceServer).EstimateGasForActionNew(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/iotexapi.APIService/EstimateGasForActionNew",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServiceServer).EstimateGasForActionNew(ctx, req.(*EstimateGasForActionRequestNew))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _APIService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EstimateGasForActionNew",
			Handler:    _APIService_EstimateGasForActionNew_Handler,
		},
		{
