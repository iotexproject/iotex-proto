...
type GetSystemLogByActionHashRequest struct {
	ActionHash           string   `protobuf:"bytes,1,opt,name=actionHash,proto3" json:"actionHash,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *GetSystemLogByActionHashRequest) Reset()         { *m = GetSystemLogByActionHashRequest{} }
func (m *GetSystemLogByActionHashRequest) String() string { return proto.CompactTextString(m) }
func (*GetSystemLogByActionHashRequest) ProtoMessage()    {}
func (*GetSystemLogByActionHashRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca6d5bbc959d58c0, []int{51}
}

func (m *GetSystemLogByActionHashRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetSystemLogByActionHashRequest.Unmarshal(m, b)
}
func (m *GetSystemLogByActionHashRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetSystemLogByActionHashRequest.Marshal(b, m, deterministic)
}
func (m *GetSystemLogByActionHashRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSystemLogByActionHashRequest.Merge(m, src)
}
func (m *GetSystemLogByActionHashRequest) XXX_Size() int {
	return xxx_messageInfo_GetSystemLogByActionHashRequest.Size(m)
}
func (m *GetSystemLogByActionHashRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetSystemLogByActionHashRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetSystemLogByActionHashRequest proto.InternalMessageInfo

func (m *GetSystemLogByActionHashRequest) GetActionHash() string {
	if m != nil {
		return m.ActionHash
	}
	return ""
...
type GetSystemLogByActionHashResponse struct {
	ActionSystemLog      *iotextypes.ActionSystemLog `protobuf:"bytes,1,opt,name=actionSystemLog,proto3" json:"actionSystemLog,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}

func (m *GetSystemLogByActionHashResponse) Reset()         { *m = GetSystemLogByActionHashResponse{} }
func (m *GetSystemLogByActionHashResponse) String() string { return proto.CompactTextString(m) }
func (*GetSystemLogByActionHashResponse) ProtoMessage()    {}
func (*GetSystemLogByActionHashResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca6d5bbc959d58c0, []int{52}
}

func (m *GetSystemLogByActionHashResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetSystemLogByActionHashResponse.Unmarshal(m, b)
}
func (m *GetSystemLogByActionHashResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetSystemLogByActionHashResponse.Marshal(b, m, deterministic)
}
func (m *GetSystemLogByActionHashResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSystemLogByActionHashResponse.Merge(m, src)
}
func (m *GetSystemLogByActionHashResponse) XXX_Size() int {
	return xxx_messageInfo_GetSystemLogByActionHashResponse.Size(m)
}
func (m *GetSystemLogByActionHashResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetSystemLogByActionHashResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetSystemLogByActionHashResponse proto.InternalMessageInfo

func (m *GetSystemLogByActionHashResponse) GetActionSystemLog() *iotextypes.ActionSystemLog {
	if m != nil {
		return m.ActionSystemLog
	}
	return nil
}

type GetSystemLogByBlockHeightRequest struct {
	BlockHeight          uint64   `protobuf:"varint,1,opt,name=blockHeight,proto3" json:"blockHeight,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *GetSystemLogByBlockHeightRequest) Reset()         { *m = GetSystemLogByBlockHeightRequest{} }
func (m *GetSystemLogByBlockHeightRequest) String() string { return proto.CompactTextString(m) }
func (*GetSystemLogByBlockHeightRequest) ProtoMessage()    {}
func (*GetSystemLogByBlockHeightRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca6d5bbc959d58c0, []int{53}
}

func (m *GetSystemLogByBlockHeightRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetSystemLogByBlockHeightRequest.Unmarshal(m, b)
}
func (m *GetSystemLogByBlockHeightRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetSystemLogByBlockHeightRequest.Marshal(b, m, deterministic)
}
func (m *GetSystemLogByBlockHeightRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSystemLogByBlockHeightRequest.Merge(m, src)
}
func (m *GetSystemLogByBlockHeightRequest) XXX_Size() int {
	return xxx_messageInfo_GetSystemLogByBlockHeightRequest.Size(m)
}
func (m *GetSystemLogByBlockHeightRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetSystemLogByBlockHeightRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetSystemLogByBlockHeightRequest proto.InternalMessageInfo

func (m *GetSystemLogByBlockHeightRequest) GetBlockHeight() uint64 {
	if m != nil {
		return m.BlockHeight
	}
	return 0
...
type GetSystemLogByBlockHeightResponse struct {
	BlockIdentifier      *iotextypes.BlockIdentifier `protobuf:"bytes,1,opt,name=blockIdentifier,proto3" json:"blockIdentifier,omitempty"`
	BlockSystemLog       *iotextypes.BlockSystemLog  `protobuf:"bytes,2,opt,name=blockSystemLog,proto3" json:"blockSystemLog,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}

func (m *GetSystemLogByBlockHeightResponse) Reset()         { *m = GetSystemLogByBlockHeightResponse{} }
func (m *GetSystemLogByBlockHeightResponse) String() string { return proto.CompactTextString(m) }
func (*GetSystemLogByBlockHeightResponse) ProtoMessage()    {}
func (*GetSystemLogByBlockHeightResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ca6d5bbc959d58c0, []int{54}
}

func (m *GetSystemLogByBlockHeightResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetSystemLogByBlockHeightResponse.Unmarshal(m, b)
}
func (m *GetSystemLogByBlockHeightResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetSystemLogByBlockHeightResponse.Marshal(b, m, deterministic)
}
func (m *GetSystemLogByBlockHeightResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSystemLogByBlockHeightResponse.Merge(m, src)
}
func (m *GetSystemLogByBlockHeightResponse) XXX_Size() int {
	return xxx_messageInfo_GetSystemLogByBlockHeightResponse.Size(m)
}
func (m *GetSystemLogByBlockHeightResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetSystemLogByBlockHeightResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetSystemLogByBlockHeightResponse proto.InternalMessageInfo

func (m *GetSystemLogByBlockHeightResponse) GetBlockIdentifier() *iotextypes.BlockIdentifier {
	if m != nil {
		return m.BlockIdentifier
	}
	return nil
...
func (m *GetSystemLogByBlockHeightResponse) GetBlockSystemLog() *iotextypes.BlockSystemLog {
	if m != nil {
		return m.BlockSystemLog
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*GetSystemLogByActionHashRequest)(nil), "iotexapi.GetSystemLogByActionHashRequest")
	proto.RegisterType((*GetSystemLogByActionHashResponse)(nil), "iotexapi.GetSystemLogByActionHashResponse")
	proto.RegisterType((*GetSystemLogByBlockHeightRequest)(nil), "iotexapi.GetSystemLogByBlockHeightRequest")
	proto.RegisterType((*GetSystemLogByBlockHeightResponse)(nil), "iotexapi.GetSystemLogByBlockHeightResponse")
...
var fileDescriptor_ca6d5bbc959d58c0 = []byte{
	...
	,
}
...
type APIServiceClient interface {
	...
	GetSystemLogByActionHash(ctx context.Context, in *GetSystemLogByActionHashRequest, opts ...grpc.CallOption) (*GetSystemLogByActionHashResponse, error)
	GetSystemLogByBlockHeight(ctx context.Context, in *GetSystemLogByBlockHeightRequest, opts ...grpc.CallOption) (*GetSystemLogByBlockHeightResponse, error)
...
func (c *aPIServiceClient) GetSystemLogByActionHash(ctx context.Context, in *GetSystemLogByActionHashRequest, opts ...grpc.CallOption) (*GetSystemLogByActionHashResponse, error) {
	out := new(GetSystemLogByActionHashResponse)
	err := c.cc.Invoke(ctx, "/iotexapi.APIService/GetSystemLogByActionHash", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIServiceClient) GetSystemLogByBlockHeight(ctx context.Context, in *GetSystemLogByBlockHeightRequest, opts ...grpc.CallOption) (*GetSystemLogByBlockHeightResponse, error) {
	out := new(GetSystemLogByBlockHeightResponse)
	err := c.cc.Invoke(ctx, "/iotexapi.APIService/GetSystemLogByBlockHeight", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServiceServer interface {
	...
	GetSystemLogByActionHash(context.Context, *GetSystemLogByActionHashRequest) (*GetSystemLogByActionHashResponse, error)
	GetSystemLogByBlockHeight(context.Context, *GetSystemLogByBlockHeightRequest) (*GetSystemLogByBlockHeightResponse, error)
	// get block info in stream
...
func (*UnimplementedAPIServiceServer) GetSystemLogByActionHash(ctx context.Context, req *GetSystemLogByActionHashRequest) (*GetSystemLogByActionHashResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSystemLogByActionHash not implemented")
}
func (*UnimplementedAPIServiceServer) GetSystemLogByBlockHeight(ctx context.Context, req *GetSystemLogByBlockHeightRequest) (*GetSystemLogByBlockHeightResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSystemLogByBlockHeight not implemented")
}
...
func _APIService_GetSystemLogByActionHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSystemLogByActionHashRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServiceServer).GetSystemLogByActionHash(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/iotexapi.APIService/GetSystemLogByActionHash",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServiceServer).GetSystemLogByActionHash(ctx, req.(*GetSystemLogByActionHashRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _APIService_GetSystemLogByBlockHeight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSystemLogByBlockHeightRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServiceServer).GetSystemLogByBlockHeight(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/iotexapi.APIService/GetSystemLogByBlockHeight",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServiceServer).GetSystemLogByBlockHeight(ctx, req.(*GetSystemLogByBlockHeightRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _APIService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSystemLogByActionHash",
			Handler:    _APIService_GetSystemLogByActionHash_Handler,
		},
		{
			MethodName: "GetSystemLogByBlockHeight",
			Handler:    _APIService_GetSystemLogByBlockHeight_Handler,
		},
		{
