...
// IIP-59: set delegate commission rate for voter reward distribution
type SetCommissionRate struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Rate          uint64                 `protobuf:"varint,1,opt,name=rate,proto3" json:"rate,omitempty"` // basis points, 0-10000 (e.g., 1000 = 10%)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ActionCore) GetSetCommissionRate() *SetCommissionRate {
	if x != nil {
		if x, ok := x.Action.(*ActionCore_SetCommissionRate); ok {
...
type ActionCore_SetCommissionRate struct {
	SetCommissionRate *SetCommissionRate `protobuf:"bytes,54,opt,name=setCommissionRate,proto3,oneof"` // IIP-59
}
...
const file_proto_types_action_proto_rawDesc = "" +
	...
	"\apayload\x18\x03 \x01(\fR\apayload\"\x97\x01\n" +
	"\tCandidate\x12\x18\n" +
	...
	"\tblsPubKey\x18\x05 \x01(\fR\tblsPubKey\"F\n" +
	"\rCandidateList\x125\n" +
	"\n" +
	...
	"\bsidecars\x18\x02 \x03(\v2\x19.iotextypes.BlobTxSidecarR\bsidecars\"\xb7\x01\n" +
	"\vStakeCreate\x12$\n" +
	...
	"\x11SetCommissionRate\x12\x12\n" +
	"\x04rate\x18\x01 \x01(\x04R\x04rate\"J\n" +
	"\fStakeReclaim\x12 \n" +
	...
	"\trecipient\x18\x04 \x01(\tR\trecipient\"\xb5\x17\n" +
	"\n" +
	"ActionCore\x12\x18\n" +
	...
	"accessList\x12\x16\n" +
	"\x06txType\x18\x1c \x01(\rR\x06txType\x122\n" +
	"\btransfer\x18\n" +
	...
	"\fstakeMigrate\x185 \x01(\v2\x18.iotextypes.StakeMigrateH\x00R\fstakeMigrate\x12M\n" +
	"\x11setCommissionRate\x186 \x01(\v2\x1d.iotextypes.SetCommissionRateH\x00R\x11setCommissionRate\x12A\n" +
...
var file_proto_types_action_proto_goTypes = []any{
	...
	(*SetCommissionRate)(nil),          // 14: iotextypes.SetCommissionRate
...
var file_proto_types_action_proto_depIdxs = []int32{
	...
	25, // 12: iotextypes.ActionCore.startSubChain:type_name -> iotextypes.StartSubChain
	26, // 13: iotextypes.ActionCore.stopSubChain:type_name -> iotextypes.StopSubChain
	28, // 14: iotextypes.ActionCore.putBlock:type_name -> iotextypes.PutBlock
	29, // 15: iotextypes.ActionCore.createDeposit:type_name -> iotextypes.CreateDeposit
	30, // 16: iotextypes.ActionCore.settleDeposit:type_name -> iotextypes.SettleDeposit
	31, // 17: iotextypes.ActionCore.createPlumChain:type_name -> iotextypes.CreatePlumChain
	32, // 18: iotextypes.ActionCore.terminatePlumChain:type_name -> iotextypes.TerminatePlumChain
	33, // 19: iotextypes.ActionCore.plumPutBlock:type_name -> iotextypes.PlumPutBlock
	34, // 20: iotextypes.ActionCore.plumCreateDeposit:type_name -> iotextypes.PlumCreateDeposit
	35, // 21: iotextypes.ActionCore.plumStartExit:type_name -> iotextypes.PlumStartExit
	36, // 22: iotextypes.ActionCore.plumChallengeExit:type_name -> iotextypes.PlumChallengeExit
	37, // 23: iotextypes.ActionCore.plumResponseChallengeExit:type_name -> iotextypes.PlumResponseChallengeExit
	38, // 24: iotextypes.ActionCore.plumFinalizeExit:type_name -> iotextypes.PlumFinalizeExit
	39, // 25: iotextypes.ActionCore.plumSettleDeposit:type_name -> iotextypes.PlumSettleDeposit
	40, // 26: iotextypes.ActionCore.plumTransfer:type_name -> iotextypes.PlumTransfer
	52, // 27: iotextypes.ActionCore.depositToRewardingFund:type_name -> iotextypes.DepositToRewardingFund
	53, // 28: iotextypes.ActionCore.claimFromRewardingFund:type_name -> iotextypes.ClaimFromRewardingFund
	54, // 29: iotextypes.ActionCore.grantReward:type_name -> iotextypes.GrantReward
	12, // 30: iotextypes.ActionCore.stakeCreate:type_name -> iotextypes.StakeCreate
	15, // 31: iotextypes.ActionCore.stakeUnstake:type_name -> iotextypes.StakeReclaim
	15, // 32: iotextypes.ActionCore.stakeWithdraw:type_name -> iotextypes.StakeReclaim
	16, // 33: iotextypes.ActionCore.stakeAddDeposit:type_name -> iotextypes.StakeAddDeposit
	17, // 34: iotextypes.ActionCore.stakeRestake:type_name -> iotextypes.StakeRestake
	18, // 35: iotextypes.ActionCore.stakeChangeCandidate:type_name -> iotextypes.StakeChangeCandidate
	19, // 36: iotextypes.ActionCore.stakeTransferOwnership:type_name -> iotextypes.StakeTransferOwnership
	21, // 37: iotextypes.ActionCore.candidateRegister:type_name -> iotextypes.CandidateRegister
	20, // 38: iotextypes.ActionCore.candidateUpdate:type_name -> iotextypes.CandidateBasicInfo
	23, // 39: iotextypes.ActionCore.candidateActivate:type_name -> iotextypes.CandidateActivate
	24, // 40: iotextypes.ActionCore.candidateEndorsement:type_name -> iotextypes.CandidateEndorsement
	22, // 41: iotextypes.ActionCore.candidateTransferOwnership:type_name -> iotextypes.CandidateTransferOwnership
	13, // 42: iotextypes.ActionCore.stakeMigrate:type_name -> iotextypes.StakeMigrate
	14, // 43: iotextypes.ActionCore.setCommissionRate:type_name -> iotextypes.SetCommissionRate
