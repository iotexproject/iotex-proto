...
type ActionCore_CandidateSelfStake struct {
	CandidateSelfStake *CandidateSelfStake `protobuf:"bytes,51,opt,name=candidateSelfStake,proto3,oneof"`
}
...
var file_proto_types_action_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0xd1, 0x01, 0x0a, 0x0d, 0x53, 0x74, 0x61, 0x72, 0x74, 0x53,
	...
	0x09, 0x72, 0x65, 0x63, 0x69, 0x70, 0x69, 0x65, 0x6e, 0x74, 0x22, 0xe5, 0x12, 0x0a, 0x0a, 0x41,
	...
	0x28, 0x0d, 0x52, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x44, 0x12, 0x32, 0x0a, 0x08, 0x74,
	0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	...
	0x61, 0x74, 0x65, 0x12, 0x41, 0x0a, 0x0d, 0x70, 0x75, 0x74, 0x50, 0x6f, 0x6c, 0x6c, 0x52, 0x65,
	...
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x50, 0x0a, 0x12, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64,
	0x61, 0x74, 0x65, 0x53, 0x65, 0x6c, 0x66, 0x53, 0x74, 0x61, 0x6b, 0x65, 0x18, 0x33, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x69, 0x6f, 0x74, 0x65, 0x78, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e,
	0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x53, 0x65, 0x6c, 0x66, 0x53, 0x74, 0x61,
	0x6b, 0x65, 0x48, 0x00, 0x52, 0x12, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x53,
	0x65, 0x6c, 0x66, 0x53, 0x74, 0x61, 0x6b, 0x65, 0x42, 0x08, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69,
	...
	0x74, 0x2a, 0x7c, 0x0a, 0x08, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x12, 0x12, 0x0a,
	...
	0x43, 0x43, 0x45, 0x53, 0x53, 0x4c, 0x49, 0x53, 0x54, 0x10, 0x03, 0x1a, 0x02, 0x10, 0x01, 0x2a,
	0x2e, 0x0a, 0x0a, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0f, 0x0a,
	0x0b, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x10, 0x00, 0x12, 0x0f,
	0x0a, 0x0b, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x10, 0x01, 0x42,
...
var file_proto_types_action_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_proto_types_action_proto_goTypes = []interface{}{
	...
	(*StartSubChain)(nil),             // 17: iotextypes.StartSubChain
	(*StopSubChain)(nil),              // 18: iotextypes.StopSubChain
	(*MerkleRoot)(nil),                // 19: iotextypes.MerkleRoot
	(*PutBlock)(nil),                  // 20: iotextypes.PutBlock
	(*CreateDeposit)(nil),             // 21: iotextypes.CreateDeposit
	(*SettleDeposit)(nil),             // 22: iotextypes.SettleDeposit
	(*CreatePlumChain)(nil),           // 23: iotextypes.CreatePlumChain
	(*TerminatePlumChain)(nil),        // 24: iotextypes.TerminatePlumChain
	(*PlumPutBlock)(nil),              // 25: iotextypes.PlumPutBlock
	(*PlumCreateDeposit)(nil),         // 26: iotextypes.PlumCreateDeposit
	(*PlumStartExit)(nil),             // 27: iotextypes.PlumStartExit
	(*PlumChallengeExit)(nil),         // 28: iotextypes.PlumChallengeExit
	(*PlumResponseChallengeExit)(nil), // 29: iotextypes.PlumResponseChallengeExit
	(*PlumFinalizeExit)(nil),          // 30: iotextypes.PlumFinalizeExit
	(*PlumSettleDeposit)(nil),         // 31: iotextypes.PlumSettleDeposit
	(*PlumTransfer)(nil),              // 32: iotextypes.PlumTransfer
	(*ActionCore)(nil),                // 33: iotextypes.ActionCore
	(*Action)(nil),                    // 34: iotextypes.Action
	(*Actions)(nil),                   // 35: iotextypes.Actions
	(*Receipt)(nil),                   // 36: iotextypes.Receipt
	(*Log)(nil),                       // 37: iotextypes.Log
	(*Logs)(nil),                      // 38: iotextypes.Logs
	(*EvmTransfer)(nil),               // 39: iotextypes.EvmTransfer
	(*EvmTransferList)(nil),           // 40: iotextypes.EvmTransferList
	(*ActionEvmTransfer)(nil),         // 41: iotextypes.ActionEvmTransfer
	(*BlockEvmTransfer)(nil),          // 42: iotextypes.BlockEvmTransfer
	(*DepositToRewardingFund)(nil),    // 43: iotextypes.DepositToRewardingFund
	(*ClaimFromRewardingFund)(nil),    // 44: iotextypes.ClaimFromRewardingFund
	(*GrantReward)(nil),               // 45: iotextypes.GrantReward
	nil,                               // 46: iotextypes.PlumPutBlock.RootsEntry
}
var file_proto_types_action_proto_depIdxs = []int32{
	...
	19, // 4: iotextypes.PutBlock.roots:type_name -> iotextypes.MerkleRoot
	46, // 5: iotextypes.PlumPutBlock.roots:type_name -> iotextypes.PlumPutBlock.RootsEntry
	...
	17, // 8: iotextypes.ActionCore.startSubChain:type_name -> iotextypes.StartSubChain
	18, // 9: iotextypes.ActionCore.stopSubChain:type_name -> iotextypes.StopSubChain
	20, // 10: iotextypes.ActionCore.putBlock:type_name -> iotextypes.PutBlock
	21, // 11: iotextypes.ActionCore.createDeposit:type_name -> iotextypes.CreateDeposit
	22, // 12: iotextypes.ActionCore.settleDeposit:type_name -> iotextypes.SettleDeposit
	23, // 13: iotextypes.ActionCore.createPlumChain:type_name -> iotextypes.CreatePlumChain
	24, // 14: iotextypes.ActionCore.terminatePlumChain:type_name -> iotextypes.TerminatePlumChain
	25, // 15: iotextypes.ActionCore.plumPutBlock:type_name -> iotextypes.PlumPutBlock
	26, // 16: iotextypes.ActionCore.plumCreateDeposit:type_name -> iotextypes.PlumCreateDeposit
	27, // 17: iotextypes.ActionCore.plumStartExit:type_name -> iotextypes.PlumStartExit
	28, // 18: iotextypes.ActionCore.plumChallengeExit:type_name -> iotextypes.PlumChallengeExit
	29, // 19: iotextypes.ActionCore.plumResponseChallengeExit:type_name -> iotextypes.PlumResponseChallengeExit
	30, // 20: iotextypes.ActionCore.plumFinalizeExit:type_name -> iotextypes.PlumFinalizeExit
	31, // 21: iotextypes.ActionCore.plumSettleDeposit:type_name -> iotextypes.PlumSettleDeposit
	32, // 22: iotextypes.ActionCore.plumTransfer:type_name -> iotextypes.PlumTransfer
	43, // 23: iotextypes.ActionCore.depositToRewardingFund:type_name -> iotextypes.DepositToRewardingFund
	44, // 24: iotextypes.ActionCore.claimFromRewardingFund:type_name -> iotextypes.ClaimFromRewardingFund
	45, // 25: iotextypes.ActionCore.grantReward:type_name -> iotextypes.GrantReward
	...
	16, // 36: iotextypes.ActionCore.candidateSelfStake:type_name -> iotextypes.CandidateSelfStake
	33, // 37: iotextypes.Action.core:type_name -> iotextypes.ActionCore
	0,  // 38: iotextypes.Action.encoding:type_name -> iotextypes.Encoding
	34, // 39: iotextypes.Actions.actions:type_name -> iotextypes.Action
	37, // 40: iotextypes.Receipt.logs:type_name -> iotextypes.Log
	37, // 41: iotextypes.Logs.logs:type_name -> iotextypes.Log
	39, // 42: iotextypes.EvmTransferList.evmTransfers:type_name -> iotextypes.EvmTransfer
	39, // 43: iotextypes.ActionEvmTransfer.evmTransfers:type_name -> iotextypes.EvmTransfer
	41, // 44: iotextypes.BlockEvmTransfer.actionEvmTransfers:type_name -> iotextypes.ActionEvmTransfer
	1,  // 45: iotextypes.GrantReward.type:type_name -> iotextypes.RewardType
...
func file_proto_types_action_proto_init() {
	...
	file_proto_types_action_proto_msgTypes[31].OneofWrappers = []interface{}{
