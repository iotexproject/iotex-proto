...
const (
	...
	// VoterRewardChunk drives one chunk of the IIP-59 era-boundary
	// voter-reward drain on a non-epoch-boundary block. Emitted only
	// while a drain cursor is live in the rewarding namespace; consumed
	// by the chain's rewarding protocol.
	RewardType_VoterRewardChunk RewardType = 2
)
...
type Candidate struct {
	...
	// IIP-59: voter reward commission rate (basis points, 0-10000) snapshotted
	// for this epoch by PutPollResult. 0 = legacy (no auto-distribution).
...
type CandidateBasicInfo struct {
	...
	// BLS proof-of-possession: a 96-byte BLS signature over a
	// domain-separated hash that includes blsPubKey and the candidate's
	// owner address. Required (post-fork) for any action that introduces
	// or rotates a blsPubKey, to prevent the classic BLS rogue-key
	// aggregate forgery against IIP-52's same-message aggregation.
	BlsPop []byte `protobuf:"bytes,5,opt,name=blsPop,proto3" json:"blsPop,omitempty"`
}
...
func (x *CandidateBasicInfo) GetBlsPop() []byte {
	if x != nil {
		return x.BlsPop
	}
	return nil
...
// IIP-59: delegate sets the voter reward commission rate (basis points, 0-10000).
// 0 = legacy (no auto-distribution); the protocol auto-splits the epoch reward
// when rate > 0.
...
func (x *SetCommissionRate) Reset() {
	*x = SetCommissionRate{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetCommissionRate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetCommissionRate) ProtoMessage() {}

func (x *SetCommissionRate) ProtoReflect() protoreflect.Message {
	mi := &file_proto_types_action_proto_msgTypes[25]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetCommissionRate.ProtoReflect.Descriptor instead.
func (*SetCommissionRate) Descriptor() ([]byte, []int) {
	return file_proto_types_action_proto_rawDescGZIP(), []int{25}
}

func (x *SetCommissionRate) GetRate() uint64 {
	if x != nil {
		return x.Rate
	}
	return 0
...
// IIP-59: delegate flips the on-chain voter-reward distribution opt-in flag.
// While opt_in is false the delegate stays on the legacy Hermes path; once
// flipped to true the protocol splits both block and epoch rewards
// per-voter using the frozen poll snapshot. Only the candidate owner may
// submit this action.
...
func (x *SetVoterRewardOptIn) Reset() {
	*x = SetVoterRewardOptIn{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetVoterRewardOptIn) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetVoterRewardOptIn) ProtoMessage() {}

func (x *SetVoterRewardOptIn) ProtoReflect() protoreflect.Message {
	mi := &file_proto_types_action_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetVoterRewardOptIn.ProtoReflect.Descriptor instead.
func (*SetVoterRewardOptIn) Descriptor() ([]byte, []int) {
	return file_proto_types_action_proto_rawDescGZIP(), []int{26}
}

func (x *SetVoterRewardOptIn) GetCandidateIdentifier() []byte {
	if x != nil {
...
func (x *SetVoterRewardOptIn) GetOptIn() bool {
	if x != nil {
		return x.OptIn
	}
	return false
...
type ActionCore struct {
	...
	//	*ActionCore_SetCommissionRate
	//	*ActionCore_SetVoterRewardOptIn
	//	*ActionCore_SetVoterRewardDestination
...
func (x *ActionCore) GetCandidateDeactivate() *CandidateDeactivate {
	if x, ok := x.GetAction().(*ActionCore_CandidateDeactivate); ok {
...
func (x *ActionCore) GetScheduleCandidateDeactivation() *ScheduleCandidateDeactivation {
	if x, ok := x.GetAction().(*ActionCore_ScheduleCandidateDeactivation); ok {
		return x.ScheduleCandidateDeactivation
	}
	return nil
}

func (x *ActionCore) GetSetCommissionRate() *SetCommissionRate {
	if x, ok := x.GetAction().(*ActionCore_SetCommissionRate); ok {
		return x.SetCommissionRate
	}
	return nil
}

func (x *ActionCore) GetSetVoterRewardOptIn() *SetVoterRewardOptIn {
	if x, ok := x.GetAction().(*ActionCore_SetVoterRewardOptIn); ok {
		return x.SetVoterRewardOptIn
	}
	return nil
}

func (x *ActionCore) GetSetVoterRewardDestination() *SetVoterRewardDestination {
	if x, ok := x.GetAction().(*ActionCore_SetVoterRewardDestination); ok {
		return x.SetVoterRewardDestination
	}
	return nil
}
...
type ActionCore_SetCommissionRate struct {
	SetCommissionRate *SetCommissionRate `protobuf:"bytes,56,opt,name=setCommissionRate,proto3,oneof"`
}

type ActionCore_SetVoterRewardOptIn struct {
	SetVoterRewardOptIn *SetVoterRewardOptIn `protobuf:"bytes,57,opt,name=setVoterRewardOptIn,proto3,oneof"`
}

type ActionCore_SetVoterRewardDestination struct {
	SetVoterRewardDestination *SetVoterRewardDestination `protobuf:"bytes,58,opt,name=setVoterRewardDestination,proto3,oneof"`
}
...
func (*ActionCore_SetCommissionRate) isActionCore_Action() {}

func (*ActionCore_SetVoterRewardOptIn) isActionCore_Action() {}

func (*ActionCore_SetVoterRewardDestination) isActionCore_Action() {}
...
func (x *ClaimFromRewardingFund) Reset() {
	*x = ClaimFromRewardingFund{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_types_action_proto_msgTypes[55]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ClaimFromRewardingFund) Descriptor() ([]byte, []int) {
	return file_proto_types_action_proto_rawDescGZIP(), []int{55}
}
...
func (x *GrantReward) Reset() {
	*x = GrantReward{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_types_action_proto_msgTypes[56]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GrantReward) Descriptor() ([]byte, []int) {
	return file_proto_types_action_proto_rawDescGZIP(), []int{56}
}
...
// IIP-59: voter selects the account that receives direct voter-reward
// payouts. An empty recipient clears the override and restores the voter as
// the effective destination. Compound payouts continue to use the voter's
// configured native staking bucket.
...
func (x *SetVoterRewardDestination) Reset() {
	*x = SetVoterRewardDestination{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_types_action_proto_msgTypes[57]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SetVoterRewardDestination) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetVoterRewardDestination) ProtoMessage() {}

func (x *SetVoterRewardDestination) ProtoReflect() protoreflect.Message {
	mi := &file_proto_types_action_proto_msgTypes[57]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetVoterRewardDestination.ProtoReflect.Descriptor instead.
func (*SetVoterRewardDestination) Descriptor() ([]byte, []int) {
	return file_proto_types_action_proto_rawDescGZIP(), []int{57}
}

func (x *SetVoterRewardDestination) GetRecipient() []byte {
	if x != nil {
		return x.Recipient
	}
	return nil
...
var file_proto_types_action_proto_rawDesc = []byte{
	...
	,
	...
	0x63, 0x65, 0x12, 0x0c, 0x0a, 0x01, 0x76, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x01, 0x76,
	0x12, 0x0c, 0x0a, 0x01, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x01, 0x72, 0x12, 0x0c,
	0x0a, 0x01, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x01, 0x73, 0x22, 0xb7, 0x01, 0x0a,
	...
	0x6f, 0x61, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f,
	0x61, 0x64, 0x22, 0xae, 0x01, 0x0a, 0x12, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65,
	...
	,
	...
	0x60, 0x0a, 0x1a, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x66, 0x65, 0x72, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x12, 0x28, 0x0a,
	0x0f, 0x6e, 0x65, 0x77, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x6e, 0x65, 0x77, 0x4f, 0x77, 0x6e, 0x65, 0x72,
	...
	,
	...
	,
	...
	0x52, 0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x2c, 0x0a, 0x05, 0x72, 0x6f, 0x6f, 0x74,
	0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x69, 0x6f, 0x74, 0x65, 0x78, 0x74,
	0x79, 0x70, 0x65, 0x73, 0x2e, 0x4d, 0x65, 0x72, 0x6b, 0x6c, 0x65, 0x52, 0x6f, 0x6f, 0x74, 0x52,
	0x05, 0x72, 0x6f, 0x6f, 0x74, 0x73, 0x22, 0x5f, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e,
	...
	0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x63,
	0x69, 0x70, 0x69, 0x65, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65,
	0x63, 0x69, 0x70, 0x69, 0x65, 0x6e, 0x74, 0x22, 0x5b, 0x0a, 0x0d, 0x53, 0x65, 0x74, 0x74, 0x6c,
	0x65, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75,
	...
	0x6e, 0x64, 0x65, 0x78, 0x22, 0x11, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x6c,
	0x75, 0x6d, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x22, 0x3e, 0x0a, 0x12, 0x54, 0x65, 0x72, 0x6d, 0x69,
	0x6e, 0x61, 0x74, 0x65, 0x50, 0x6c, 0x75, 0x6d, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x12, 0x28, 0x0a,
	0x0f, 0x73, 0x75, 0x62, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x73, 0x75, 0x62, 0x43, 0x68, 0x61, 0x69, 0x6e,
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xc5, 0x01, 0x0a, 0x0c, 0x50, 0x6c, 0x75, 0x6d,
	0x50, 0x75, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x28, 0x0a, 0x0f, 0x73, 0x75, 0x62, 0x43,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x85, 0x1b, 0x0a, 0x0a, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x72, 0x65, 0x12, 0x18,
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x12, 0x1a,
	...
	,
	...
	0x6e, 0x73, 0x66, 0x65, 0x72, 0x12, 0x3b, 0x0a, 0x0b, 0x74, 0x78, 0x43, 0x6f, 0x6e, 0x74, 0x61,
	0x69, 0x6e, 0x65, 0x72, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x69, 0x6f, 0x74,
	0x65, 0x78, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x54, 0x78, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69,
	0x6e, 0x65, 0x72, 0x48, 0x00, 0x52, 0x0b, 0x74, 0x78, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	...
	,
	...
	0x12, 0x30, 0x0a, 0x08, 0x65, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x14, 0x2e, 0x69, 0x6f, 0x74, 0x65, 0x78, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e,
	0x45, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x08, 0x65, 0x6e, 0x63, 0x6f, 0x64, 0x69,
	0x6e, 0x67, 0x22, 0x37, 0x0a, 0x07, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x2c, 0x0a,
	...
	,
	...
	,
	...
	0x61, 0x63, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x6f,
	...
	,
	...
	0x04, 0x6c, 0x6f, 0x67, 0x73, 0x22, 0x49, 0x0a, 0x0b, 0x45, 0x76, 0x6d, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x66, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01,
	...
	0x22, 0x4e, 0x0a, 0x0f, 0x45, 0x76, 0x6d, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x4c,
	0x69, 0x73, 0x74, 0x12, 0x3b, 0x0a, 0x0c, 0x65, 0x76, 0x6d, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66,
	0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x69, 0x6f, 0x74, 0x65,
	...
	0x22, 0x9a, 0x01, 0x0a, 0x11, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x76, 0x6d, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x12, 0x1e, 0x0a, 0x0a, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x48, 0x61, 0x73, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x61, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x48, 0x61, 0x73, 0x68, 0x12, 0x28, 0x0a, 0x0f, 0x6e, 0x75, 0x6d, 0x45, 0x76, 0x6d,
	...
	,
	...
	0x6e, 0x45, 0x76, 0x6d, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x73, 0x22, 0x44, 0x0a,
	0x16, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x54, 0x6f, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64,
	0x69, 0x6e, 0x67, 0x46, 0x75, 0x6e, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e,
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12,
	0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x22, 0x5e, 0x0a, 0x16, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x46, 0x72, 0x6f, 0x6d,
	0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x46, 0x75, 0x6e, 0x64, 0x12, 0x16, 0x0a,
	...
	,
	...
	,
...
var file_proto_types_action_proto_msgTypes = make([]protoimpl.MessageInfo, 59)
var file_proto_types_action_proto_goTypes = []any{
	...
	(*SetCommissionRate)(nil),             // 27: iotextypes.SetCommissionRate
	(*SetVoterRewardOptIn)(nil),           // 28: iotextypes.SetVoterRewardOptIn
	(*StartSubChain)(nil),                 // 29: iotextypes.StartSubChain
	(*StopSubChain)(nil),                  // 30: iotextypes.StopSubChain
	(*MerkleRoot)(nil),                    // 31: iotextypes.MerkleRoot
	(*PutBlock)(nil),                      // 32: iotextypes.PutBlock
	(*CreateDeposit)(nil),                 // 33: iotextypes.CreateDeposit
	(*SettleDeposit)(nil),                 // 34: iotextypes.SettleDeposit
	(*CreatePlumChain)(nil),               // 35: iotextypes.CreatePlumChain
	(*TerminatePlumChain)(nil),            // 36: iotextypes.TerminatePlumChain
	(*PlumPutBlock)(nil),                  // 37: iotextypes.PlumPutBlock
	(*PlumCreateDeposit)(nil),             // 38: iotextypes.PlumCreateDeposit
	(*PlumStartExit)(nil),                 // 39: iotextypes.PlumStartExit
	(*PlumChallengeExit)(nil),             // 40: iotextypes.PlumChallengeExit
	(*PlumResponseChallengeExit)(nil),     // 41: iotextypes.PlumResponseChallengeExit
	(*PlumFinalizeExit)(nil),              // 42: iotextypes.PlumFinalizeExit
	(*PlumSettleDeposit)(nil),             // 43: iotextypes.PlumSettleDeposit
	(*PlumTransfer)(nil),                  // 44: iotextypes.PlumTransfer
	(*ActionCore)(nil),                    // 45: iotextypes.ActionCore
	(*Action)(nil),                        // 46: iotextypes.Action
	(*Actions)(nil),                       // 47: iotextypes.Actions
	(*ActionHash)(nil),                    // 48: iotextypes.ActionHash
	(*Receipt)(nil),                       // 49: iotextypes.Receipt
	(*Log)(nil),                           // 50: iotextypes.Log
	(*Logs)(nil),                          // 51: iotextypes.Logs
	(*EvmTransfer)(nil),                   // 52: iotextypes.EvmTransfer
	(*EvmTransferList)(nil),               // 53: iotextypes.EvmTransferList
	(*ActionEvmTransfer)(nil),             // 54: iotextypes.ActionEvmTransfer
	(*BlockEvmTransfer)(nil),              // 55: iotextypes.BlockEvmTransfer
	(*DepositToRewardingFund)(nil),        // 56: iotextypes.DepositToRewardingFund
	(*ClaimFromRewardingFund)(nil),        // 57: iotextypes.ClaimFromRewardingFund
	(*GrantReward)(nil),                   // 58: iotextypes.GrantReward
	(*SetVoterRewardDestination)(nil),     // 59: iotextypes.SetVoterRewardDestination
	nil,                                   // 60: iotextypes.PlumPutBlock.RootsEntry
}
var file_proto_types_action_proto_depIdxs = []int32{
	...
	31, // 5: iotextypes.PutBlock.roots:type_name -> iotextypes.MerkleRoot
	60, // 6: iotextypes.PlumPutBlock.roots:type_name -> iotextypes.PlumPutBlock.RootsEntry
	...
	29, // 13: iotextypes.ActionCore.startSubChain:type_name -> iotextypes.StartSubChain
	30, // 14: iotextypes.ActionCore.stopSubChain:type_name -> iotextypes.StopSubChain
	32, // 15: iotextypes.ActionCore.putBlock:type_name -> iotextypes.PutBlock
	33, // 16: iotextypes.ActionCore.createDeposit:type_name -> iotextypes.CreateDeposit
	34, // 17: iotextypes.ActionCore.settleDeposit:type_name -> iotextypes.SettleDeposit
	35, // 18: iotextypes.ActionCore.createPlumChain:type_name -> iotextypes.CreatePlumChain
	36, // 19: iotextypes.ActionCore.terminatePlumChain:type_name -> iotextypes.TerminatePlumChain
	37, // 20: iotextypes.ActionCore.plumPutBlock:type_name -> iotextypes.PlumPutBlock
	38, // 21: iotextypes.ActionCore.plumCreateDeposit:type_name -> iotextypes.PlumCreateDeposit
	39, // 22: iotextypes.ActionCore.plumStartExit:type_name -> iotextypes.PlumStartExit
	40, // 23: iotextypes.ActionCore.plumChallengeExit:type_name -> iotextypes.PlumChallengeExit
	41, // 24: iotextypes.ActionCore.plumResponseChallengeExit:type_name -> iotextypes.PlumResponseChallengeExit
	42, // 25: iotextypes.ActionCore.plumFinalizeExit:type_name -> iotextypes.PlumFinalizeExit
	43, // 26: iotextypes.ActionCore.plumSettleDeposit:type_name -> iotextypes.PlumSettleDeposit
	44, // 27: iotextypes.ActionCore.plumTransfer:type_name -> iotextypes.PlumTransfer
	56, // 28: iotextypes.ActionCore.depositToRewardingFund:type_name -> iotextypes.DepositToRewardingFund
	57, // 29: iotextypes.ActionCore.claimFromRewardingFund:type_name -> iotextypes.ClaimFromRewardingFund
	58, // 30: iotextypes.ActionCore.grantReward:type_name -> iotextypes.GrantReward
	...
	27, // 46: iotextypes.ActionCore.setCommissionRate:type_name -> iotextypes.SetCommissionRate
	28, // 47: iotextypes.ActionCore.setVoterRewardOptIn:type_name -> iotextypes.SetVoterRewardOptIn
	59, // 48: iotextypes.ActionCore.setVoterRewardDestination:type_name -> iotextypes.SetVoterRewardDestination
	5,  // 49: iotextypes.ActionCore.putPollResult:type_name -> iotextypes.PutPollResult
	45, // 50: iotextypes.Action.core:type_name -> iotextypes.ActionCore
	0,  // 51: iotextypes.Action.encoding:type_name -> iotextypes.Encoding
	46, // 52: iotextypes.Actions.actions:type_name -> iotextypes.Action
	50, // 53: iotextypes.Receipt.logs:type_name -> iotextypes.Log
	50, // 54: iotextypes.Logs.logs:type_name -> iotextypes.Log
	52, // 55: iotextypes.EvmTransferList.evmTransfers:type_name -> iotextypes.EvmTransfer
	52, // 56: iotextypes.ActionEvmTransfer.evmTransfers:type_name -> iotextypes.EvmTransfer
	54, // 57: iotextypes.BlockEvmTransfer.actionEvmTransfers:type_name -> iotextypes.ActionEvmTransfer
	1,  // 58: iotextypes.GrantReward.type:type_name -> iotextypes.RewardType
...
func file_proto_types_action_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_types_action_proto_msgTypes[22].Exporter = func(v any, i int) any {
			switch v := v.(*CandidateDeactivate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_types_action_proto_msgTypes[23].Exporter = func(v any, i int) any {
			switch v := v.(*ScheduleCandidateDeactivation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_types_action_proto_msgTypes[25].Exporter = func(v any, i int) any {
			switch v := v.(*SetCommissionRate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_types_action_proto_msgTypes[26].Exporter = func(v any, i int) any {
			switch v := v.(*SetVoterRewardOptIn); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_types_action_proto_msgTypes[52].Exporter = func(v any, i int) any {
		...
		file_proto_types_action_proto_msgTypes[53].Exporter = func(v any, i int) any {
		...
		file_proto_types_action_proto_msgTypes[54].Exporter = func(v any, i int) any {
		...
		file_proto_types_action_proto_msgTypes[55].Exporter = func(v any, i int) any {
		...
		file_proto_types_action_proto_msgTypes[56].Exporter = func(v any, i int) any {
		...
		file_proto_types_action_proto_msgTypes[57].Exporter = func(v any, i int) any {
			switch v := v.(*SetVoterRewardDestination); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_proto_types_action_proto_msgTypes[43].OneofWrappers = []any{
		...
		(*ActionCore_SetCommissionRate)(nil),
		(*ActionCore_SetVoterRewardOptIn)(nil),
		(*ActionCore_SetVoterRewardDestination)(nil),
