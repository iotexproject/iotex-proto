...
type BlockHeaderCore struct {
	...
	NumActions           uint64               `protobuf:"varint,9,opt,name=numActions,proto3" json:"numActions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *BlockHeaderCore) GetNumActions() uint64 {
	if m != nil {
		return m.NumActions
	}
	return 0
...
var fileDescriptor_0e828f5966a7c29d = []byte{
	...
	,
}
