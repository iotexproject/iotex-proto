...
type CandidateV2 struct {
	...
	CommissionRate          uint64                 `protobuf:"varint,10,opt,name=commissionRate,proto3" json:"commissionRate,omitempty"`                   // IIP-59: basis points (0-10000)
	CommissionRateLastEpoch uint64                 `protobuf:"varint,11,opt,name=commissionRateLastEpoch,proto3" json:"commissionRateLastEpoch,omitempty"` // IIP-59: epoch of last commission change
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *CandidateV2) GetCommissionRateLastEpoch() uint64 {
	if x != nil {
...
const file_proto_types_state_data_proto_rawDesc = "" +
	...
	"iotextypes\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc5\x01\n" +
	"\x16ProbationCandidateList\x12M\n" +
	"\rprobationList\x18\x01 \x03(\v2'.iotextypes.ProbationCandidateList.InfoR\rprobationList\x12$\n" +
	"\rintensityRate\x18\x02 \x01(\rR\rintensityRate\x1a6\n" +
	"\x04Info\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x14\n" +
	"\x05count\x18\x02 \x01(\rR\x05count\"\xe0\x05\n" +
	"\n" +
	"VoteBucket\x12\x14\n" +
	...
	"\abuckets\x18\x01 \x03(\v2\x16.iotextypes.VoteBucketR\abuckets\"\xb3\x03\n" +
	"\vCandidateV2\x12\"\n" +
	...
	"\x0ecommissionRate\x18\n" +
	" \x01(\x04R\x0ecommissionRate\x128\n" +
	"\x17commissionRateLastEpoch\x18\v \x01(\x04R\x17commissionRateLastEpoch\"J\n" +
