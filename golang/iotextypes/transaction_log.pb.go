...
type TransactionStructLog struct {
	...
	GasCost    string   `protobuf:"bytes,4,opt,name=gasCost,proto3" json:"gasCost,omitempty"`
...
func (x *TransactionStructLog) GetGas() string {
	if x != nil {
		return x.Gas
	}
	return ""
...
func (x *TransactionStructLog) GetGasCost() string {
	if x != nil {
		return x.GasCost
	}
	return ""
...
var file_proto_types_transaction_log_proto_rawDesc = []byte{
	...
	0x67, 0x61, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x67, 0x61, 0x73, 0x12, 0x18,
	0x0a, 0x07, 0x67, 0x61, 0x73, 0x43, 0x6f, 0x73, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
